...
identity rotation or framing. The time window allows retained old incidents to
stop causing an active quarantine; configured retention ceilings can eventually
rotate those records out.
